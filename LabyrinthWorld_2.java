...
/**
 * Ergänzen Sie hier eine Beschreibung für die Klasse LabyrinthWorld_2.
 * 
 * @author (Ihr Name) 
 * @version (eine Versionsnummer oder ein Datum)
 */
public class LabyrinthWorld_2 extends LabyrinthWorld {

    /**
     * Konstruktor für Objekte der Klasse LabyrinthWorld_2
     * 
     */
    public LabyrinthWorld_2() {
        super(14, 15);
        prepare();
    }
    /**
    ...
    private void prepare() {
        ...
        for (int i=1;i<14;i++) {
            ...
            if (i != 9) addObject(new Rock(),i,13);
        }
